...
imdb %>% 
  ...
  ggplot2::labs(
    ...
    subtitle = "Considerando apenas o gênero 1 de cada filme",
    x = "Gênero",
    y = "Quantidade",
    caption = "Fonte: IMDB",
  ) +
